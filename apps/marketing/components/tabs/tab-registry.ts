...
const registry: Record<TabType, () => Promise<{ default: TabComponent }>> = {
  ...
  'logistic-regression': () => import('./types/LogisticRegressionTab'),
  'hypothesis-test': () => import('./types/HypothesisTestTab'),
  'cross-tab': () => import('./types/CrossTabTab'),
  'time-series': () => import('./types/TimeSeriesTab'),
  'data-cleaning': () => import('./types/DataCleaningTab'),
  'data-join': () => import('./types/DataJoinTab'),
